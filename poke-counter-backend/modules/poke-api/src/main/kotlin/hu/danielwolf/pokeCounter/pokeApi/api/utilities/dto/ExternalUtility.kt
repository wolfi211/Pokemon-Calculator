...
package hu.danielwolf.pokeCounter.pokeApi.api.utilities.dto
...
data class ExternalEncounter(
  ...
  @param:JsonProperty("condition_values") val conditionValues: List<NamedAPIResource>,
  val chance: Int,
...
data class ExternalVerboseEffect(
  val effect: String,
  @param:JsonProperty("short_effect") val shortEffect: String,
  val language: NamedAPIResource,
)

data class ExternalVersionEncounterDetail(
  val version: NamedAPIResource,
  @param:JsonProperty("max_chance") val maxChance: Int,
  @param:JsonProperty("encounter_details") val encounterDetails: List<ExternalEncounter>,
)
